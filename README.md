...
*   **Enterprise Backend:** 2 years of Java (Spring Boot, J2EE), Oracle WebLogic, high-availability architecture.
*   **Agile Leadership:** 3 years of project management experience, Certified Professional Scrum Master (PSM I), experienced in leading sprints and removing technical blockers.
...
<div style="display: flex; flex-wrap: wrap; gap: 20px;">
  <div style="flex: 1 1 40%; min-width: 300px;">
    ...
    <div align="center"><img src="assets/images/SolanaRWA-17082026.gif" alt="Solana RWA Enterprise Bridge Preview" height="380px" /></div>
  </div>
  <div style="flex: 1 1 40%; min-width: 300px;">
    ...
    <div align="center"><img src="assets/images/SolanaStakerMobile-01082026.gif" alt="Solana Staker Mobile Preview" height="380px" /></div>
  </div>
  <div style="flex: 1 1 40%; min-width: 300px;">
    ...
    <div align="center"><img src="assets/images/CryptoListings-01082026.gif" alt="Crypto Listings Preview" height="380px" /></div>
  </div>
</div>
...
*   **Web3 Bridge:** Engineered custom mobile integration layers that successfully bridge traditional enterprise infrastructures with Solana dApp architectures.
*   **Performance Architecture:** Restructured legacy enterprise codebases and native apps to fix memory leaks, streamline network calls, and significantly lower latency.
*   **Production Delivery:** Actively directed complex, cross-functional mobile development sprints from initial wireframes to high-precision live production deployment.
